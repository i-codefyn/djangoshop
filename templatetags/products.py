...
def render_product2(context, product):
    """
    ...
    names = [
        "oscar/catalogue/partials/product-2/upc-%s.html" % product.upc,
        "oscar/catalogue/partials/product-2/class-%s.html"
        % product.get_product_class().slug,
        "oscar/catalogue/partials/product-2.html",
    ]

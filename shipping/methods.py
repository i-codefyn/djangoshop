...
class Free(Base):
    ...
    """
    code = 'shipping-expenses'
    name = _('Shipping Expenses')


    def calculate(self, basket):
        self.message = messages
        if basket.num_items == 3 or basket.num_items == 4:
        ...
        elif basket.num_items == 5:
            message = "Free Watch"
            print("Free Watch")
            return prices.Price(
                currency=basket.currency,
                excl_tax=D('30.00'), tax=D('0.00'))

        elif basket.num_items == 6 or basket.num_items == 7 or basket.num_items == 8 or basket.num_items == 9:
            message = "Shipping is free + Free Watch"
            print("Shipping is free + Free Watch")
            return prices.Price(
                currency=basket.currency,
                excl_tax=D('00.00'), tax=D('0.00'))

        elif basket.num_items == 10:
            message = "Shipping is free + Free Two Watch"
            print("Shipping is free + Free Two Watch")
            return prices.Price(
                currency=basket.currency,
                excl_tax=D('00.00'), tax=D('0.00'))

        else:
            print("Shipping charges = 30 SR")
            message = "Shipping charges = 30 SR"

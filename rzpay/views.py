...
class PaymentView(CheckoutSessionMixin, View):
    ...
    def _start_razorpay_txn(self, basket, **kwargs):
        ...
        context = {
            ...
            "logo_url": getattr(
                settings, "RAZORPAY_VENDOR_LOGO", "https://via.placeholder.com/150x150"
            ),
        }
        return context
...
class SuccessResponseView(PaymentDetailsView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            messages.error(
                self.request, _("Unable to determine Razorpay transaction details")
            )
        ...
        try:
            ...
            messages.error(
                self.request,
                _(
                    "A problem occurred communicating with Razorpay - "
        ...
        if not kwargs["basket"]:
            ...
            messages.error(
                self.request,
                _(
                    "No basket was found that corresponds to your "
    ...
    def build_submission(self, **kwargs):
        ...
        # submission["order_total"] = self.txn.amount
        # Pass PP params
    ...
    def handle_payment(self, order_number, total, **kwargs):
        ...
        self.add_payment_event(
            "Settled", confirm_txn.amount, reference=confirm_txn.rz_id
        )

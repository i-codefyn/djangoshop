...
from .translation import ProductTranslationOptions, CategoryTranslationOption
...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ('get_title', 'upc', 'get_product_class', 'structure',
                    'attribute_summary', 'date_created', 'featured', 'popular', 'colour')
    list_filter = ['structure', 'is_discountable', 'featured', 'popular', 'colour']
